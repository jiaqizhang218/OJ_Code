...
int bin[20];
int n,m,cnt,ans,top,ind,blo,blonum,root;
int res[100005],p[50005],fa[50005][17],deep[50005],c[50005],st[50005],dfn[50005],belong[50005];
bool vis[50005];
...
void reverse(int x)
{
	if(!vis[x]) {vis[x]=1;if(++p[c[x]]==1)ans++;}
	else {vis[x]=0;if(--p[c[x]]==0)ans--;}
}
